...
Сайт доступен по ссылке: http://92.255.109.92:9999/

API:
Все книги - метод GET: http://92.255.109.92:9999/api/all_books/
Книга - метод GET: http://92.255.109.92:9999/api/get_book/<int:pk>
